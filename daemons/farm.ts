	...
	setVar $BOT~help[18] $BOT~tab&"[destroyports] - will destroy all non-class 3 ports during build"
	setVar $BOT~help[19] $BOT~tab&"         [one] - only pops 1 planet when none exist during build"
	...
	setVar $BOT~help[29] $BOT~tab&"   [barricade] - moves all fighters from planets to home sector"
	setVar $BOT~help[30] $BOT~tab&"  [armageddon] - destroys all planets and ports (kills colos)"
