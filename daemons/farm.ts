	...
	setVar $BOT~help[9]  $BOT~tab&"           {f} - will strip fuel, org, equip off planets"
	setVar $BOT~help[10] $BOT~tab&"           {o} - will strip fuel, org, equip off planets"
	setVar $BOT~help[11] $BOT~tab&"           {e} - will strip fuel, org, equip off planets"
