	...
	setVar $BOT~help[8]  $BOT~tab&"         [neg] - will attempt to sell product in farm sector only"
	setVar $BOT~help[9]  $BOT~tab&"        [half] - only sell half of port capacity when warping"
