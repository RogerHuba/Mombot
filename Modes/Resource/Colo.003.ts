...
#HELP FILE
        ...
        setVar $BOT~help[3]  $BOT~tab&"colo [r/s/m/t] {misc} {t/b} {f} {c:x}  "
        setVar $BOT~help[4]  $BOT~tab&"         "
        setVar $BOT~help[5]  $BOT~tab&"Options: "
        setVar $BOT~help[6]  $BOT~tab&"   - [r/s/m/t] = [r]ed/[s]peed/[m]ilk/[t]imed"
        ...
        setVar $BOT~help[7]  $BOT~tab&"     red   = jump sector - sector next to terra"
        setVar $BOT~help[10] $BOT~tab&"   - [misc]  = cycles/min colos/delay"
        setVar $BOT~help[11] $BOT~tab&"   - [t/b]   = [t]warp/[b]warp  (defy"
        setVar $BOT~help[12] $BOT~tab&"   - [f]   = Bwarp Only - Pick up fuel every 2nd trip"
        setVar $BOT~help[13] $BOT~tab&"   - [c:x]   = [c]amo holds (example: c:3 adds 3 holds extra fuel)"
        gosub :BOT~help_file
...
:colo_setup
	...
	if (($parm1 <> "s") AND ($parm1 <> "m") AND ($parm1 <> "t") AND ($parm1 <> "r"))
		setVar $SWITCHBOARD~message "Please use colo [s]peed, [m]ilk, [r]ed, or [t]imed*"
		gosub :SWITCHBOARD~switchboard
		halt
	end
