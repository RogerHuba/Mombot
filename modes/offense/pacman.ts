	...
	logging off
	gosub :BOT~loadVars
	setVar $BOT~command "pacman"
	loadVar $BOT~bot_turn_limit
	loadVar $MAP~stardock
	loadvar $bot~subspace

	setVar $BOT~help[1]   $BOT~tab&"pacman "
	setVar $BOT~help[2]   $BOT~tab&"     Reacts to grid hits by traveling to them and searching"
	setVar $BOT~help[3]   $BOT~tab&"     to destroy"
