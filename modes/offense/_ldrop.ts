	...
	setVar $BOT~help[5]    $BOT~tab&"              or after {delay}.  if {return} is set  "
	setVar $BOT~help[6]    $BOT~tab&"              plock cancels and returns after 5 seconds"
	setVar $BOT~help[7]    $BOT~tab&"    {foton} - lands 1 sector away and starts density foton"
	setVar $BOT~help[8]    $BOT~tab&"     {kill} - attempts to kill after drop (direct or plock)"
	setVar $BOT~help[9]    $BOT~tab&" {holokill} - attempts to holokill after drop (direct or plock)"
