	...
	setVar $BOT~help[11] $BOT~tab&"     {t}ow      - twarp tow a photon in a second ship"
	setVar $BOT~help[12] $BOT~tab&"   "
	setVar $BOT~help[13] $BOT~tab&"     {towship}  - Ship in sector with photon you will tow"
	setVar $BOT~help[14] $BOT~tab&"     {sector}   - Apply the mode from/to that sector"
	setVar $BOT~help[15] $BOT~tab&"     {return}   - Returns Planet Home after Pwarp"
	setVar $BOT~help[16] $BOT~tab&"      {den40}   - Only shoots on 40 to 499 Density Change"
	setVar $BOT~help[17] $BOT~tab&"       {holo}   - does holo command after firing"
	setVar $BOT~help[18] $BOT~tab&"    {dockexp}   - Will pop planet to get to 1k for dock photon"
	setVar $BOT~help[19] $BOT~tab&"  "
	setVar $BOT~help[20] $BOT~tab&"       Authors: Mind Dagger and The Bounty Hunter "
	gosub :bot~helpfile
