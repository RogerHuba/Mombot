...
setVar $BOT~help[7]   $BOT~tab&"      {foton} - Scans ports and fires foton at tertiary port."
setVar $BOT~help[8]   $BOT~tab&"   {announce} - Primary/Secondary search only, announces hits. "
setVar $BOT~help[9]   $BOT~tab&"  {fotonlist} - Targets list of ports supplid via mombot prompt "
setVar $BOT~help[10]  $BOT~tab&"  {prtargets} - Targets sectors with param: PRTARGETS"
setVar $BOT~help[11]  $BOT~tab&" {checkports} - Must be run regularly for accurate targetting. "
setVar $BOT~help[12]  $BOT~tab&"      {3warp} - search for ports with at least 3 warps"
setVar $BOT~help[13]  $BOT~tab&"      {4warp} - search for ports with at least 4 warps"
setVar $BOT~help[14]  $BOT~tab&"      {5warp} - search for ports with at least 5 warps"
setVar $BOT~help[15]  $BOT~tab&"      {6warp} - search for ports with at least 6 warps"
setVar $BOT~help[16]  $BOT~tab&"      {bwarp} - uses bwarp from citadel prompt"
setVar $BOT~help[17]  $BOT~tab&"       {kill} - pgrid into sector and attempt kill (dangerous)"
setVar $BOT~help[18]  $BOT~tab&"   {surround} - (optimistically) surrounds sector before kill "
setVar $BOT~help[19]  $BOT~tab&"        {pig} - Bring a friend to lift and IG during kill cycle"
setVar $BOT~help[20]  $BOT~tab&"     {direct} - Skip secondary scan"
setVar $BOT~help[21]  $BOT~tab&"  {retrigger} - Continue photoning until out of photons"
setVar $BOT~help[22]  $BOT~tab&" {lock:param} - Locks clais"
setVar $BOT~help[23]  $BOT~tab&"   {holokill} - holokills after photon "
setVar $BOT~help[24]  $BOT~tab&"     "
setVar $BOT~help[25]  $BOT~tab&" Search Pattern"
setVar $BOT~help[26]  $BOT~tab&"   1) Primary   - wide search any open port with greater or equ"
setVar $BOT~help[27]  $BOT~tab&"                  {3warp/4warp/5warp/6warp} warps. 4 default."
setVar $BOT~help[28]  $BOT~tab&"   2) Secondary - Scan 120 ports 120 times for second hit"
setVar $BOT~help[29]  $BOT~tab&"   3) Tertiary  - Scan 20 nearest ports with firing solutions"
setVar $BOT~help[30]  $BOT~tab&"                  240 times looking for a foton shot"
setVar $BOT~help[31]  $BOT~tab&"  "
setVar $BOT~help[32]  $BOT~tab&"   When Tertiary port is covered it attempts to foton."
setVar $BOT~help[33]  $BOT~tab&"  "
setVar $BOT~help[34]  $BOT~tab&"   Above numbers are default config with {n1 n2 n3 n4} "
setVar $BOT~help[35]  $BOT~tab&"     = {2ndPort# 2ndScanTimes TertPort# TertScanTimes}"
setVar $BOT~help[36]  $BOT~tab&"     prhunt 60 250 15 200 "
setVar $BOT~help[37]  $BOT~tab&"     - Scan 60 secondary ports 250 times"
setVar $BOT~help[38]  $BOT~tab&"     - Scan 15 tertiary ports 200 times"
setVar $BOT~help[39]  $BOT~tab&"     "
setVar $BOT~help[40]  $BOT~tab&"     Example:"
setVar $BOT~help[41]  $BOT~tab&"        >prhunt foton kill"
