	...
	setVar $BOT~help[5]  $BOT~tab&"         {f} - Trigger on fighter hits (Default is true, unless others are set)"
	setVar $BOT~help[6]  $BOT~tab&"         {l} - Trigger on limpet hits (Default is true, unless others are set)"
	setVar $BOT~help[7]  $BOT~tab&"         {a} - Trigger on armid hits (Default is true, unless others are set)"
	...
	setVar $BOT~help[14] $BOT~tab&"  {holokill} - holokill if possible"
	setVar $BOT~help[15] $BOT~tab&" {slingshot} - will pgrid holokill"
