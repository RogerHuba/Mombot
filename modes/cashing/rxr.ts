...
setVar $BOT~help[1] $BOT~tab&" rxr [ship1] [ship2] {ship3} {shipn} {resetlra}*"
setVar $BOT~help[2] $BOT~tab&"  "
setVar $BOT~help[3] $BOT~tab&"  Takes a list of ships and robs those ports until"
setVar $BOT~help[4] $BOT~tab&"  it has nothing to rob or runs out of xport options."
setVar $BOT~help[5] $BOT~tab&"  "
setVar $BOT~help[6] $BOT~tab&"  Does not mega rob."
