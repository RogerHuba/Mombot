...
#                      "2" if failed to create planet
	...
	setVar $BOT~help[6]    $BOT~tab&"    {create:} - List of planet types to make. "
	setVar $BOT~help[7]    $BOT~tab&"                Any unique word of planet types separated"
	setVar $BOT~help[8]    $BOT~tab&"                by commas and no spaces.  Default will use "
	setVar $BOT~help[9]    $BOT~tab&"                keeper planets in preferences."
	setVar $BOT~help[10]   $BOT~tab&"{custom name} - Name the planet will be.  Otherwise it's a "
	setVar $BOT~help[11]   $BOT~tab&"                random name from a database              "
	setVar $BOT~help[12]   $BOT~tab&"                              "
	setVar $BOT~help[13]   $BOT~tab&"      Examples:                   "
	setVar $BOT~help[14]   $BOT~tab&"            >make planet create:earth,volcanic,oceanic "
	setVar $BOT~help[15]   $BOT~tab&"            >create planet ewarp create:earth         "
	setVar $BOT~help[16]   $BOT~tab&"            >make planet "&#34&"death"&#34&" create:volcanic "
