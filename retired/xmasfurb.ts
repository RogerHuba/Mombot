# buy shields! min 1500

# R The Bo XmasTime@ hunt 7 7802
...
setVar $BOT~help[1]  $BOT~tab&"       Xmas Furb Script "
setVar $BOT~help[2]  $BOT~tab&"        "
setVar $BOT~help[3]  $BOT~tab&"       Delivers ship with Torps and Atomics to trader (MOOXMAS)."
setVar $BOT~help[4]  $BOT~tab&"       Start in one trading ship at SD; other in use by person "
setVar $BOT~help[5]  $BOT~tab&"       running MOOXMAS furb."
setVar $BOT~help[6]  $BOT~tab&"       Requires a sitship with 20+ XPort (Snowball/Grimwolds)"
setVar $BOT~help[7]  $BOT~tab&"       at the StarDock also."
setVar $BOT~help[8]  $BOT~tab&" "
setVar $BOT~help[9]  $BOT~tab&"       xmasfurb [sitship]"
setVar $BOT~help[10]  $BOT~tab&"    "
setVar $BOT~help[11]  $BOT~tab&"    [sitship]      number of ship in sector to sit in during furbs "
...
setVar $sitShip $bot~parm1
isNumber $number $sitShip

if ($number <> 1)
	setvar $switchboard~message "Please enter the sit ship number.*"
	gosub :switchboard~switchboard
	halt
...
send "wn" $sitShip "*"
waitfor "Available Ships in Sector"
setTextLineTrigger checkShip1 :checkShip1 "You lock your Tractor Beam on"
setTextTrigger checkShip2 :checkShip2 "Command ["
pause
	:checkShip2
		killalltriggers
		setvar $switchboard~message "Sit ship should be here also.*"
		gosub :switchboard~switchboard
		halt
	:checkShip1
		killalltriggers
...
:WaitingForInst
	...
	:topofwait
	setTextTrigger waitFurb :waitFurb "XmasTime@"
