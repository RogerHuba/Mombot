...
loadVar $command
	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- "&$command&" [sector] {defend}                            " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "     clears adjacent fighters and calls saveme              " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                            " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "     - [defend] for offensive fighters,just enters/retreats "
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                            " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "     - From Citadel prompt grabs fighters from planet       " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "     - From Command prompt grabs fighters from the sector   " 
