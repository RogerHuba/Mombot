...
# received this source in.
  ...
  if ($doesHelpFileExist <> TRUE)
    write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- wppt {holoscan} {evade}" 
    write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "  World PPT - Originally written by Xide                          " 
    ...
    write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
    write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - {nohaggle}    = doesn't haggle                               " 
    write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
