...
:start_figs
	gosub :turnOffAnsi
	send "'{" $bot_name "} Loading current fighter locations. . .*"
...
:refreshFighters
	...
	:doneCounting
		...
		delete $FIG_FILE
		delete $CK_FIG_FILE
		write $FIG_FILE $output
		write $FIG_FILE DATE
		write $FIG_FILE TIME
		write $CK_FIG_FILE $ckoutput
