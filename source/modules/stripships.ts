...
if ($doesHelpFileExist <> TRUE)
	...
	write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    Strips fighters from all empty ships and deploys them   " 
	write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    into the sector.                                        " 
