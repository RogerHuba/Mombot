...
:Starting
	...
	setVar $x1000 (" " & $user_command_line & " ")
	lowercase $x1000
	...
	if ($CREDITS < 200000)
		send "'{" $bot_name "} - You must have at least 200,000 credits on hand to run WorldSST.*"
		halt
	end
	...
	setVar $alarm_check (" " & $user_command_line & " ")
	...
	if ($pos = 0)
		...
		if (($safe_ship = $psst_ship1) OR ($safe_ship = $psst_ship2))
