...
:load_script
	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- sgrid {figs} {armids} {limpets} {min_unfigged} {safety} {planets} {warp} {norefurb}" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "  Surround gridder. Visits all targeted sectors and surrounds     " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "  them before twarping back.                                      " 
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: 3                             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [min_unfigged]  = Minimum unfigged sectors needed to surround " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: 3                             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [safety]      = 'ultra', 'safe', and 'none'                  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "              none = Will surround all figged sectors             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "              safe = Will surround sectors that have corp limps   " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "             ultra = Like safe, but needs friendly armids too     " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: none                          " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [planets]     = 'all', 'shielded'                            " 
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [restart]     = Automatically restarts gridding when finished" 
