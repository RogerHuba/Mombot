	...
	if ($doesHelpFileExist <> TRUE)
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    Mows to unfigged sectors defined in sector param given. " 
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    {figstodrop}  - fighters to drop (default is 1)          " 
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    {notwarp}  - don't attempt twarp                        " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    {all}  - visits all sectors whether fig is down or not  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                            " 
