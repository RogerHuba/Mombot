...
:help_file
     ...
     IF (($doesHelpFileExist <> TRUE) or ($parm1 = "help") or ($parm1 = "?"))
       ...
       IF ($doesHelpFileExist <> TRUE)
		write "scripts\mombot\help\"&$command&".txt" "- farm {set} {clear} {list} {fig} {f} (o) (e)               "
		write "scripts\mombot\help\"&$command&".txt" "                                                            "
		write "scripts\mombot\help\"&$command&".txt" "    [set(door)] {sector}                                    "
		write "scripts\mombot\help\"&$command&".txt" "       - Marks sector as a Bubble Sector / Door             "
		...
		write "scripts\mombot\help\"&$command&".txt" "    [fig]                                                   "
		write "scripts\mombot\help\"&$command&".txt" "       - will strip fighters off planets in target sectors  "
		write "scripts\mombot\help\"&$command&".txt" "    [f]                                                     "
		write "scripts\mombot\help\"&$command&".txt" "       - will strip fuel off planets in target sectors      "
		write "scripts\mombot\help\"&$command&".txt" "    [o]                                                     "
		write "scripts\mombot\help\"&$command&".txt" "       - will strip organics off planets in target sectors  "
		write "scripts\mombot\help\"&$command&".txt" "    [e]                                                     "
		write "scripts\mombot\help\"&$command&".txt" "       - will strip equipment off planets in target sectors  "
		write "scripts\mombot\help\"&$command&".txt" "    [coln]                                                  "
		write "scripts\mombot\help\"&$command&".txt" "       - will adjust colonists on planets                   "
		write "scripts\mombot\help\"&$command&".txt" "    [merch]                                                 "
		write "scripts\mombot\help\"&$command&".txt" "       - will fire up Planet Merchant to sell Product       "
		write "scripts\mombot\help\"&$command&".txt" "    [silent]                                                "
		write "scripts\mombot\help\"&$command&".txt" "       - supressed subspace messages                        "
		write "scripts\mombot\help\"&$command&".txt" "    [reverse]                                               "
		write "scripts\mombot\help\"&$command&".txt" "       - travels farm sectors in reverse                    "
		write "scripts\mombot\help\"&$command&".txt" "    [warp]                                                  "
		write "scripts\mombot\help\"&$command&".txt" "       - will warp planets to sell product                  "
		write "scripts\mombot\help\"&$command&".txt" "    [cash]                                                  "
		write "scripts\mombot\help\"&$command&".txt" "       - will grab cash off farm planets if any avaliable   "
		write "scripts\mombot\help\"&$command&".txt" "    [shield]                                                "
		write "scripts\mombot\help\"&$command&".txt" "       - will ensure 200 Shields on shielded planets         "
		write "scripts\mombot\help\"&$command&".txt" "    [Colo]                                              "
		write "scripts\mombot\help\"&$command&".txt" "       - will colonize planets with avaliable fuel          "
