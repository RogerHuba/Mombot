...
:load_script
	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- ugrid [targeting] {figs} {armids} {limpets} {safety} {planets} {warp} {refurb} {scrub} {avoid) {aggressive} {clear} {noansi} {ship2:#)" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "  Ultimate gridder. Visits all targeted sectors. " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                            " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [targeting]   = How target list is generated.  Must be either" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     a filename to pull list from or 'auto' which "
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     will autogenerate list of targets.           " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [figs]        = Number of fighters to drop                   " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: 1                             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [armids]      = Number of armid mines to drop                " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: 3                             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [limps]       = Number of limpet mines to drop               " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: 3                             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [exist]       = Overwrite grid               " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [safety]      = 'ultra', 'safe', and 'none'                  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "              none = Will land adjacent to all non-figged sectors " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "              safe = Only will land to sectors with friendly limps" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "             ultra = Like safe, but needs friendly armids too     " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: ultra                         " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [planets]     = 'all', 'shielded', 'none'                    " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "               all = Avoid all planets in target sectors          " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "          shielded = Avoid only shielded planets in target sectors" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: all                           " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [warp]        = 'twarp' or 'bwarp'                           " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                         - Default: twarp                         " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [norefurb]    = Turns off auto refurbing of mines at Stardock" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [scrub]       = Will scrub at dock when catching a limpet    " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [avoid]       = Avoid sectors with enemy limpets             " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [aggressive]  = Won't avoid big fighter groups               " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [passive]     = Avoids hitting player fighters or mines.     " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [clear]       = Clears internal list of avoided sectors.     " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - [ship2:#]     = Second xport ship number     " 
