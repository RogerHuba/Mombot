	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- farm {set} {clear} {list} {f} {o} {e} {fig}                                " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "    Visits sectors in list and farms the planets there.     " 
		...
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "       " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   {f} - farms fuel ore" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   {o} - farms organics" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   {e} - farms equipment" 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   {fig} - farms fighters" 
