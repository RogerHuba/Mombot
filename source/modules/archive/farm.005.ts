	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\mombot\help\"&$command&".txt" "- farm {set} {clear} {list} {f} {o} {e} {fig}                                " 
		...
		write "scripts\mombot\help\"&$command&".txt" "       " 
		write "scripts\mombot\help\"&$command&".txt" "   {f} - farms fuel ore" 
		write "scripts\mombot\help\"&$command&".txt" "   {o} - farms organics" 
		write "scripts\mombot\help\"&$command&".txt" "   {e} - farms equipment" 
		write "scripts\mombot\help\"&$command&".txt" "   {fig} - farms fighters" 
