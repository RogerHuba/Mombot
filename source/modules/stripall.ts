	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\mombot\help\"&$command&".txt" "- stripall {set} {clear} {list} {f} {o} {e} {fig}                                " 
		write "scripts\mombot\help\"&$command&".txt" "    Visits sectors in list and strips the planets there.     " 
		...
		write "scripts\mombot\help\"&$command&".txt" "       " 
		write "scripts\mombot\help\"&$command&".txt" "    {personal}   " 
		write "scripts\mombot\help\"&$command&".txt" "       - goes to all personal planets instead of corp" 
		write "scripts\mombot\help\"&$command&".txt" "       " 
		write "scripts\mombot\help\"&$command&".txt" "   {f} - strips fuel ore" 
		write "scripts\mombot\help\"&$command&".txt" "   {o} - strips organics" 
		write "scripts\mombot\help\"&$command&".txt" "   {e} - strips equipment" 
		write "scripts\mombot\help\"&$command&".txt" "   {fig} - strips fighters" 
		write "scripts\mombot\help\"&$command&".txt" "       - default is all" 
