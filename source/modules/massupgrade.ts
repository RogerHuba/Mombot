...
# received this source in.
	...
	if ($doesHelpFileExist <> TRUE)
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "- "&$command&" {holoscan} {evade} {seek}                          " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "  Mass Upgrage - Originally written by Xide                       " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - {holoscan}    = 0 - doesn't holoscan                         " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     1 - holoscans on odd densities               "
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     2 - always holoscans (default)               " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - {evade}       = 0 - normal (default)                         " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     1 - paranoid                                 " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                     2 - avoids nothing                           " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "   - {seek}        = Seeks resources outside sector for upgrades  " 
		write "scripts\"&$bot~mombot_directory&"\help\"&$command&".txt" "                                                                  " 
