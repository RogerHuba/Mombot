	...
	setVar $BOT~help[1] $BOT~tab&"PE - Photon, Enter, Move - Move to die"
	...
	setVar $BOT~help[7] $BOT~tab&"     Added a move to ensure death on entry "
...
#	setVar $BOT~help[11] $BOT~tab&"{mac:nnn}   run some random macro at end - BUGGY STILL"
    ...
    setVar $INVADER~speed_invade_macro  $INVADER~enter&"     *    m0* * *  m0* * *  m0* * *  m0* * *  "
    setVar $INVADER~normal_invade_macro $INVADER~enter&"*          m0* * *  m0* * *  m0* * *  m0* * *  m0* * *    "
