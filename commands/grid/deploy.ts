	...
	setVar $BOT~help[10]  $BOT~tab&"   [plimp/climp/cmine/pmine] - drops mines (default 1)"
	...
	setVar $BOT~help[19]  $BOT~tab&"   [mines] - drops both mine types (default 3) "
	...
	setVar $BOT~help[26]  $BOT~tab&"           >deploy 10000 figs"
	setVar $BOT~help[27]  $BOT~tab&"           >deploy 100000"
	setVar $BOT~help[28]  $BOT~tab&"           >put 100 personal"
	gosub :bot~helpfile
