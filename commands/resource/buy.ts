...
:_Start_
	...
	setVar $BOT~help[7]  $BOT~tab&"  -     [mode] = [b]est or [s]peed or [w]orst - default is speed  "
	setVar $BOT~help[8]  $BOT~tab&"  -   [cycles] = number of cycles             - default is max   " 
	setVar $BOT~help[9]  $BOT~tab&"  - [override] = allows product buydowns with less than 200 holds" 
	...
	setVar $BOT~help[18] $BOT~tab&"  - [paranoid] = make sure both sectors have corp limpets and armids"
	setVar $BOT~help[19] $BOT~tab&"  -     [safe] = make sure both sectors have corp limpets "
