...
:status
    ...
    setVar $h[16] "Cloaks    : "
    setVar $h[17] "Beacons   : "
    setVar $h[18] "AtomicDets: "
    setVar $h[19] "Corbomite : "
    setVar $h[20] "E-Probes  : "
    setVar $h[21] "Disruptors: "
    setVar $h[22] "PsiProbe  : "
    setVar $h[23] "PlanetScan: "
    setVar $h[24] "Scanner   : "
...
:qss_send
    ...
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[11]&$qss_var[5]&$qss_var[12]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[6]&$qss_var[25]&$qss_var[21]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[7]&$qss_var[26]&$qss_var[20]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[8]&$qss_var[17]&$qss_var[14]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[9]&$qss_var[22]&$qss_var[18]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[10]&$qss_var[19]&$qss_var[23]&"*"
    setVar $SWITCHBOARD~message $SWITCHBOARD~message&$qss_var[2]&$qss_var[15]&$qss_var[24]&"*"
